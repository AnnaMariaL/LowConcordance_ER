...
#original code: Neda Barghi "Genetic redundancy fuels polygenic adaptation in Drosophila", adapted by Anna Maria Langmueller 
...
parser.add_argument('--gen', required=True, dest='generation', type=int, help="Time of development in generation")
...
my_generation=args.generation

generations = [0,my_generation]
replicates = 10
