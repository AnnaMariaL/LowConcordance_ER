...
#Purpose: neutral simulations for an empirical p-value distribution of the FET tests
...
my.coverages<-read.csv("../data_emp/data_averageCoverage_PLoS.csv",sep=";",dec=",")
my.nes<-readRDS("NeEstimates.rds")
my.files<-list.files(pattern="*CovSampled.txt")
