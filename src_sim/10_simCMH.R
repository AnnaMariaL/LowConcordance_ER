...
#Purpose: neutral simulations for an empirical p-value distribution of the CMH test 
...
my.files<-list.files(pattern=glob2rx("*_CovSampled.txt"),path = "../data_sim",full.names = T)
print(my.files)

#form 06_Ne_estimation.R
my.ne<-readRDS("../data_sim/NeEstimates.rds")
